    ...
    <>
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          ...
          <div className="col-md-10">
            <img src="/images/ur.jpeg" alt="maslaimagen"
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/aaron.jpeg" alt="maslaimagen"
              style={{display: 'block', margin: 'auto', maxWidth: '100%', maxHeight: '900px'}} />
          </div>
          <div className="col-md-1" />
        </div>
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/capitalism.jpeg" alt="maslaimagen"
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/jud.jpeg" alt="maslaimagen"
              style={{display: 'block', margin: 'auto', maxWidth: '100%', maxHeight: '800px'}} />
          </div>
          <div className="col-md-1" />
        </div>
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/procer.jpeg" alt="maslaimagen"
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/flu.jpeg" alt="maslaimagen"
              style={{display: 'block', margin: 'auto', maxWidth: '100%', maxHeight: '500px'}} />
          </div>
          <div className="col-md-1" />
        </div>
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/bim.jpeg" alt="maslaimagen"
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/cha.jpeg" alt="maslaimagen"
              style={{display: 'block', margin: 'auto', maxWidth: '100%', maxHeight: '500px'}} />
          </div>
          <div className="col-md-1" />
        </div>
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/politics.jpeg" alt="maslaimagen"
              style={{display: 'block', margin: 'auto', maxWidth: '100%', maxHeight: '500px'}} />
          </div>
          <div className="col-md-1" />
        </div>
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/eco.jpeg" alt="maslaimagen"
              style={{display: 'block', margin: 'auto', maxWidth: '100%', maxHeight: '500px'}} />
          </div>
          <div className="col-md-1" />
        </div>
        ...
        <div className="row" style={{marginBottom: '60px'}}>
          <div className="col-md-1" />
          <div className="col-md-10">
            <img src="/images/puebla.jpeg" alt="maslaimagen"
