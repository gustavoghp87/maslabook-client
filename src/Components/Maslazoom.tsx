...
export const Maslazoom = () => {
  ...
  <>
    <div className="container maslazoom" style={{maxWidth: mobile ? '100%' : '80%', marginBottom:'100px'}}>
          ...
          <div className="container" style={{paddingBottom: '100px'}}>
            <div className="row">
              <div className="col-lg-7" style={{display: 'block', margin: 'auto', marginLeft: '0%', marginRight: '0%'}}>
                <iframe width={700} height={400} style={{margin:'auto', maxWidth:'100%'}} src={maslazoom.src}
                  frameBorder={0} allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                  allowFullScreen title={index.toString()}
                />
              </div>
              <div className="col-lg-5">
                <div className="card-header destacados">
                  <h3> {maslazoom.h3} </h3>
                  <h4 style={{fontSize: mobile ? '1.1rem' : ''}}> {maslazoom.h4} </h4>
      ...
      <Button variant={"danger"} className="fontsforweb_fontid_77695" onClick={()=>setLimit(limit+3)}
       style={{width:'90%', height:'80px', display: limit<total ? 'block' : 'none', margin:'auto', marginTop:'50px'}}>
        ver más
      </Button>


      <hr style={{marginBottom: '35px', width: '100%', border: '1px solid #3b5998', borderRadius: '5px', display: limit<total ? 'none' : ''}} />
      
      
      <div style={{display: limit<total ? 'none' : ''}}>
